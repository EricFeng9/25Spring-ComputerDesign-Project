...
module instruction_fetch(
    ...
    imemory32 instruction_memory(
        ...
        .upg_wen_i(kick_off ? 1'b0 : upg_wen & ~upg_adr[14]),  // UART写使能（仅写入指令存储器）
        .upg_adr_i(upg_adr[13:0]),                   // UART地址
        .upg_dat_i(upg_dat),                         // UART数据
        .upg_done_i(upg_done)                        // UART完成标志
    );
